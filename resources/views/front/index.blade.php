                                    ...
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="product-details.html">
                                                <img class="default-img" src="{{asset('front/assets/imgs/shop/product-1-1.jpg')}}"
                                                    alt="">
                                                <img class="hover-img" src="{{asset('front/assets/imgs/shop/product-1-2.jpg')}}"
                                                    alt="">
                                            </a>
                                        </div>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-6">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="product-details.html">
                                                <img class="default-img" src="{{asset('front/assets/imgs/shop/product-2-1.jpg')}}"
                                                    alt="">
                                                <img class="hover-img" src="{{asset('front/assets/imgs/shop/product-2-2.jpg')}}"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-6">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="product-details.html">
                                                <img class="default-img" src="{{asset('front/assets/imgs/shop/product-3-1.jpg')}}"
                                                    alt="">
                                                <img class="hover-img" src="{{asset('front/assets/imgs/shop/product-3-2.jpg')}}"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-6">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="product-details.html">
                                                <img class="default-img" src="{{asset('front/assets/imgs/shop/product-4-1.jpg')}}"
                                                    alt="">
                                                <img class="hover-img" src="{{asset('front/assets/imgs/shop/product-4-2.jpg')}}"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-6">
                                <div class="product-cart-wrap mb-xs-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="product-details.html">
                                                <img class="default-img" src="{{asset('front/assets/imgs/shop/product-5-1.jpg')}}"
                                                    alt="">
                                                <img class="hover-img" src="{{asset('front/assets/imgs/shop/product-5-2.jpg')}}"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-6">
                                <div class="product-cart-wrap mb-xs-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="product-details.html">
                                                <img class="default-img" src="{{asset('front/assets/imgs/shop/product-6-1.jpg')}}"
                                                    alt="">
                                                <img class="hover-img" src="{{asset('front/assets/imgs/shop/product-6-2.jpg')}}"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-6">
                                <div class="product-cart-wrap mb-xs-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="product-details.html">
                                                <img class="default-img" src="{{asset('front/assets/imgs/shop/product-7-1.jpg')}}"
                                                    alt="">
                                                <img class="hover-img" src="{{asset('front/assets/imgs/shop/product-7-2.jpg')}}"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-6">
                                <div class="product-cart-wrap">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="product-details.html">
                                                <img class="default-img" src="{{asset('front/assets/imgs/shop/product-8-1.jpg')}}"
                                                    alt="">
                                                <img class="hover-img" src="{{asset('front/assets/imgs/shop/product-8-2.jpg')}}"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-6">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="product-details.html">
                                                <img class="default-img" src="{{asset('front/assets/imgs/shop/product-9-1.jpg')}}"
                                                    alt="">
                                                <img class="hover-img" src="{{asset('front/assets/imgs/shop/product-9-2.jpg')}}"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-6">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="product-details.html">
                                                <img class="default-img" src="{{asset('front/assets/imgs/shop/product-10-1.jpg')}}"
                                                    alt="">
                                                <img class="hover-img" src="{{asset('front/assets/imgs/shop/product-10-2.jpg')}}"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-6">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="product-details.html">
                                                <img class="default-img" src="{{asset('front/assets/imgs/shop/product-11-1.jpg')}}"
                                                    alt="">
                                                <img class="hover-img" src="{{asset('front/assets/imgs/shop/product-11-2.jpg')}}"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-6">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="product-details.html">
                                                <img class="default-img" src="{{asset('front/assets/imgs/shop/product-12-1.jpg')}}"
                                                    alt="">
                                                <img class="hover-img" src="{{asset('front/assets/imgs/shop/product-12-2.jpg')}}"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-6">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="product-details.html">
                                                <img class="default-img" src="{{asset('front/assets/imgs/shop/product-13-1.jpg')}}"
                                                    alt="">
                                                <img class="hover-img" src="{{asset('front/assets/imgs/shop/product-13-2.jpg')}}"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-6">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="product-details.html">
                                                <img class="default-img" src="{{asset('front/assets/imgs/shop/product-14-1.jpg')}}"
                                                    alt="">
                                                <img class="hover-img" src="{{asset('front/assets/imgs/shop/product-14-2.jpg')}}"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-6">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="product-details.html">
                                                <img class="default-img" src="{{asset('front/assets/imgs/shop/product-15-1.jpg')}}"
                                                    alt="">
                                                <img class="hover-img" src="{{asset('front/assets/imgs/shop/product-15-2.jpg')}}"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-6">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="product-details.html">
                                                <img class="hover-img" src="{{asset('front/assets/imgs/shop/product-3-1.jpg')}}"
                                                    alt="">
                                                <img class="default-img" src="{{asset('front/assets/imgs/shop/product-3-2.jpg')}}"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-6">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="product-details.html">
                                                <img class="hover-img" src="{{asset('front/assets/imgs/shop/product-4-1.jpg')}}"
                                                    alt="">
                                                <img class="default-img" src="{{asset('front/assets/imgs/shop/product-4-2.jpg')}}"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-6">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="product-details.html">
                                                <img class="hover-img" src="{{asset('front/assets/imgs/shop/product-5-1.jpg')}}"
                                                    alt="">
                                                <img class="default-img" src="{{asset('front/assets/imgs/shop/product-5-2.jpg')}}"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-6">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="product-details.html">
                                                <img class="hover-img" src="{{asset('front/assets/imgs/shop/product-6-1.jpg')}}"
                                                    alt="">
                                                <img class="default-img" src="{{asset('front/assets/imgs/shop/product-6-2.jpg')}}"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-6">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="product-details.html">
                                                <img class="hover-img" src="{{asset('front/assets/imgs/shop/product-7-1.jpg')}}"
                                                    alt="">
                                                <img class="default-img" src="{{asset('front/assets/imgs/shop/product-7-2.jpg')}}"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-6">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="product-details.html">
                                                <img class="hover-img" src="{{asset('front/assets/imgs/shop/product-8-1.jpg')}}"
                                                    alt="">
                                                <img class="default-img" src="{{asset('front/assets/imgs/shop/product-8-2.jpg')}}"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-6">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="product-details.html">
                                                <img class="hover-img" src="{{asset('front/assets/imgs/shop/product-9-1.jpg')}}"
                                                    alt="">
                                                <img class="default-img" src="{{asset('front/assets/imgs/shop/product-9-2.jpg')}}"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
        ...
        <section class="banner-2 section-padding pb-0">
            <div class="container">
                <div class="banner-img banner-big wow fadeIn animated f-none">
                    <img src="{{asset('front/assets/imgs/banner/banner-4.png')}}" alt="">
                    ...
                    <div class="carausel-6-columns" id="carausel-6-columns">
                        <div class="card-1">
                            <figure class=" img-hover-scale overflow-hidden">
                                <a href="shop.html"><img src="{{asset('front/assets/imgs/shop/category-thumb-1.jpg')}}"
                                        alt=""></a>
                            </figure>
                        ...
                        <div class="card-1">
                            <figure class=" img-hover-scale overflow-hidden">
                                <a href="shop.html"> <img src="{{asset('front/assets/imgs/shop/category-thumb-2.jpg')}}"
                                        alt=""></a>
                            </figure>
                        ...
                        <div class="card-1">
                            <figure class=" img-hover-scale overflow-hidden">
                                <a href="shop.html"><img src="{{asset('front/assets/imgs/shop/category-thumb-3.jpg')}}"
                                        alt=""></a>
                            </figure>
                        ...
                        <div class="card-1">
                            <figure class=" img-hover-scale overflow-hidden">
                                <a href="shop.html"><img src="{{asset('front/assets/imgs/shop/category-thumb-4.jpg')}}"
                                        alt=""></a>
                            </figure>
                        ...
                        <div class="card-1">
                            <figure class=" img-hover-scale overflow-hidden">
                                <a href="shop.html"><img src="{{asset('front/assets/imgs/shop/category-thumb-5.jpg')}}"
                                        alt=""></a>
                            </figure>
                        ...
                        <div class="card-1">
                            <figure class=" img-hover-scale overflow-hidden">
                                <a href="shop.html"><img src="{{asset('front/assets/imgs/shop/category-thumb-6.jpg')}}"
                                        alt=""></a>
                            </figure>
                        ...
                        <div class="card-1">
                            <figure class=" img-hover-scale overflow-hidden">
                                <a href="shop.html"><img src="{{asset('front/assets/imgs/shop/category-thumb-7.jpg')}}"
                                        alt=""></a>
                            </figure>
                        ...
                        <div class="card-1">
                            <figure class=" img-hover-scale overflow-hidden">
                                <a href="shop.html"><img src="{{asset('front/assets/imgs/shop/category-thumb-8.jpg')}}"
                                        alt=""></a>
                            </figure>
