    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
            <li class="text-primary logo-link">
                ...
                <i class="mdi  mdi-chart-bubble text-primary" style="font-size:40px"></i>
                <span class="menu-title text-bold "
                    style="font-size: 25px">{{ !empty($shop_details) ? $shop_details['shop_name'] : '' }} </span>
                <hr>
            ...
            <li class="nav-item">
                ...
                <a class="nav-link
                @if (Session::get('page') == 'dashboard') bg-primary text-primary @endif"
                    id="next-page-link" href="{{ url('admin/dashboard') }}">
            ...
            <li class="nav-item">
                <a class="nav-link
                @if (Session::get('page') == 'pos') bg-primary text-primary @endif" " href="{{ route('pos_page') }}">
 ...
 @endif
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="form-elements">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"><a
                                    class="nav-link  @if (Session::get('page') == 'salary-management') bg-white text-primary @endif"
                                    href="{{ url('admin/salary-management') }}">Issue Salarie(s)</a>
                            </li>
                            <li class="nav-item"><a
                                    class="nav-link  @if (Session::get('page') == 'all-salaries') bg-white text-primary @endif"
                ...
                <li class="nav-item">
                    <a class="nav-link
                            @if (Session::get('page') == 'shop-details') bg-primary text-primary @endif" " href="{{ url('admin/shop-details') }}">
