...
public function removeImg()
{
     ...
     public function submitaddNewadmin(){
        ...
        // data validation
            ...
            if ($record_count >= 1) {
                ...
                if ($this->photo) {
                    $admin->image = $this->store_pic($this->photo, $admin->name);
                }
                $admin->save();
                $this->photo='';
    ...
    $this->rules['photo'] = 'image';
           ...
           $validated_data = Validator::make($this->inputs, $this->val_admin_obj)->validate();
            ...
            if ($this->photo) {
                ...
                $validated_data['image'] = $this->store_pic($this->photo, $this->inputs['name']);
    ...
    //     AdminModel::create($validated_data);
    //     redirect()->back();
    //     $this->dispatchBrowserEvent('hide-add-admin-modal',["success_msg"=>'New admin Added Successfully']);
    ...
    public function render()
    {
        ...
        // $admins_by_type=AdminModel::latest()->paginate(15)->toArray();
        ...
        return view('livewire.admin.admins.admins-wired',['admins'=>  $admins]);
    }
}
